...
var GameplayUI = /** @class */ (function (_super) {
    ...
    function GameplayUI(scene, layer) {
        var _this = _super.call(this, 'Gameplay', scene, layer) || this;
        _this.initialize();
        return _this;
    }
    ...
    GameplayUI.prototype.setUpControls = function () {
        this._countdown = this.getControl('Countdown');
    };
    GameplayUI.prototype.setVisible = function (visible) {
    ...
    GameplayUI.prototype.updateCountdown = function (countdown) {
        this._countdown.text = "".concat(countdown);
    };
    return GameplayUI;
